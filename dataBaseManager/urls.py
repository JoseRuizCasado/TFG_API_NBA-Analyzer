...
urlpatterns = [
    path('teams/', ListTeamsView.as_view(), name='list-all-teams'),
    ...
    path('game/<int:game_id>', GetGameById.as_view(), name='get-game-by-id'),
    path('game-by-local-team/<int:local_team_id>', ListGamesByLocalTeamId.as_view(), name='get-game-by-local-team-id'),
    path('game-by-visitor-team/<int:visitor_team_id>', ListGamesByVisitorTeamId.as_view(), name='get-game-by-visitor-team-id'),
    path('game-by-winner-team/<int:winner_team_id>', ListGamesByWinnerTeamId.as_view(), name='get-game-by-winner-team-id')
]
